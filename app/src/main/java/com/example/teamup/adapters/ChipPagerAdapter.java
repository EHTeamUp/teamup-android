    ...
    public static class ChipPageViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(List<Object> items, LayoutInflater inflater) {
            ...
            for (Object item : items) {
                ...
                if (item instanceof com.example.teamup.api.model.Skill) {
                    com.example.teamup.api.model.Skill skill = (com.example.teamup.api.model.Skill) item;
                    chip.setText(skill.getName());
                    chip.setTag(skill.getSkillId());
                } else if (item instanceof com.example.teamup.api.model.Role) {
                    com.example.teamup.api.model.Role role = (com.example.teamup.api.model.Role) item;
