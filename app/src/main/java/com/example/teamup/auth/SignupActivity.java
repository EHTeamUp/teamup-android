...
public class SignupActivity extends AppCompatActivity {
    ...
    private void checkUserId() {
        ...
        Call<UserIdCheckResponse> call = com.example.teamup.api.RetrofitClient.getInstance().getApiService().checkUserId(request);
    ...
    private void sendEmailVerification() {
        ...
        com.example.teamup.api.RetrofitClient.getInstance().getApiService().sendEmailVerification(request).enqueue(new Callback<EmailVerificationResponse>() {
            @Override
    ...
    private void verifyEmailCode() {
        ...
        com.example.teamup.api.RetrofitClient.getInstance().getApiService().verifyEmail(request).enqueue(new Callback<EmailVerificationResponse>() {
            @Override
            public void onResponse(Call<EmailVerificationResponse> call, Response<EmailVerificationResponse> response) {
                runOnUiThread(() -> {
                    if (response.isSuccessful() && response.body() != null) {
